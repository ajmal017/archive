...
import { contentsRef, db } from '../../../firebase_config';
import notifier from '../../../mixins/notifier';
import modal from '../../../components/shared/Modal';
import dropdown from '../../../components/shared/Dropdown';
import checkbox from '../../../components/shared/Checkbox';
import contentFilters from '../../../mixins/contentFilters';
...
export default {
	...
	mounted() {
		this.content = Object.assign(
			{},
			(this.contents.filter(content => (content['.key'] === this.$route.params.key)))[0]
		);
	...
	methods: {
		findField(field) {
			for (const key in this.content.fields) {
